 ...
 * @since  3.2
 */
class JViewCategorycustfeed extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		foreach ($items as $item)
		{
			...
			if (!empty($images->image_fulltext)) {
				$feedImage = new JFeedImage();
				$feedImage->url = JRoute::_($images->image_fulltext);
				$feedImage->title = $images->image_fulltext_alt;
				$feedImage->description = $images->image_fulltext_caption;
				$feedImage->link = JRoute::_($images->image_fulltext);
